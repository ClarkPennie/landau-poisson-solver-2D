...
#SBATCH -N 64       # The number of nodes. n/N tasks are launched on each node. used in conjunction with the -n option (above). Use this option to specify launching less than 16 tasks per node. 
...
ibrun tacc_affinity  ./source/LPsolver_2D_NoField
