...
void PrintMarginalLoc(FILE *margfile_x1v1, FILE *margfile_x2v2, FILE *margfile_x1x2);

void PrintMarginal(vector<double>& U_vals, FILE *margfile_x1v1, FILE *margfile_x2v2, FILE *margfile_x1x2);
